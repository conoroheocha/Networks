...
public class Client2 extends Node {
    static final int DEFAULT_SRC_PORT = 50005; // Port of the client. These need to be different for all the files as they are used somehow in the setup
     ...
     * the destinations
     */
 /*   Client2(Terminal terminal, String dstHost, int dstPort, int srcPort) {
        try {
