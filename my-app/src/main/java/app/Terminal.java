...
/**
 * This class provides both terminal windows that provides field for input from
 * the user and output to the user.
 *
 */
public class Terminal {
	...
	/**
	 * This class contains Terminal window, an output field, a label and an input
	 * field. The output field can print Strings. The label is used to print an
	 * instruction to user. The input field can be used to request a String as input
	 * from the user - username and password
	 */
